...
FOSSIL_SUITE(c_behavior_driven_development_suite);

// Setup function for the test suite
FOSSIL_SETUP(c_behavior_driven_development_suite) {}

// Teardown function for the test suite
FOSSIL_TEARDOWN(c_behavior_driven_development_suite) {}
...
FOSSIL_TEST(c_behavior_driven_development_test_simple_math) {
...
FOSSIL_TEST(c_behavior_driven_development_test_unsigned_math) {
...
FOSSIL_TEST(c_behavior_driven_development_test_signed_math) {
...
FOSSIL_TEST(c_behavior_driven_development_test_soap_rot_brain) {
...
FOSSIL_TEST(c_behavior_driven_development_test_soap_tone_detection) {
    GIVEN("a formal text") {
...
FOSSIL_TEST_GROUP(c_behavior_driven_development_tests) {
    FOSSIL_TEST_ADD(c_behavior_driven_development_suite, c_behavior_driven_development_test_simple_math);
    FOSSIL_TEST_ADD(c_behavior_driven_development_suite, c_behavior_driven_development_test_unsigned_math);
    FOSSIL_TEST_ADD(c_behavior_driven_development_suite, c_behavior_driven_development_test_signed_math);
    FOSSIL_TEST_ADD(c_behavior_driven_development_suite, c_behavior_driven_development_test_soap_rot_brain);
    FOSSIL_TEST_ADD(c_behavior_driven_development_suite, c_behavior_driven_development_test_soap_tone_detection);

    FOSSIL_TEST_REGISTER(c_behavior_driven_development_suite);
}
