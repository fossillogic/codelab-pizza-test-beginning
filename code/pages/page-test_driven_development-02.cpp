...
FOSSIL_TEST(cpp_test_driven_development_test_soap_rot_brain) {
    // Arrange
...
FOSSIL_TEST(cpp_test_driven_development_test_soap_tone_detection) {
    // Arrange
    const char *formal_text = "Dear Sir or Madam, I hope this message finds you well.";
    const char *casual_text = "Hey, what's up?";
    const char *sarcastic = "Oh, great, another meeting. Just what I needed.";
    ...
    ASSUME_ITS_SOAP_TONE_DETECTED(sarcastic, "sarcastic");
