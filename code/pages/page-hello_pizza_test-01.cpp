...
FOSSIL_TEST(cpp_hello_pizza_test_simple_math) {
    int result = 2 + 2;
    ASSUME_ITS_EQUAL_I32(4, result);
}

FOSSIL_TEST(cpp_hello_pizza_test_unsigned_math) {
    uint32_t actual = 10;
    uint32_t expected = 5;
...
FOSSIL_TEST(cpp_hello_pizza_test_signed_math) {
    int32_t actual = -10;
    int32_t expected = -5;
...
FOSSIL_TEST(cpp_hello_pizza_test_soap_rot_brain) {
...
FOSSIL_TEST(cpp_hello_pizza_test_soap_tone_detection) {
...
FOSSIL_TEST(cpp_hello_pizza_test_cstr_equality) {
...
FOSSIL_TEST(cpp_hello_pizza_test_cstr_length) {
    const char *text = "hello";
    ASSUME_ITS_LENGTH_EQUAL_CSTR(text, 5);
    ASSUME_NOT_LENGTH_EQUAL_CSTR(text, 10);
}

FOSSIL_TEST(cpp_hello_pizza_test_cstr_prefix_suffix) {
...
FOSSIL_TEST(cpp_hello_pizza_test_likely_unlikely_conditions) {
...
FOSSIL_TEST(cpp_hello_pizza_test_pointer_equality) {
    void *ptr1 = (void *)0x1;
    void *ptr2 = (void *)0x1;
    void *ptr3 = (void *)0x2;
...
FOSSIL_TEST(cpp_hello_pizza_test_size_comparisons) {
    size_t size1 = 10;
    size_t size2 = 20;
...
FOSSIL_TEST_GROUP(cpp_hello_pizza_tests) {
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_simple_math);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_unsigned_math);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_signed_math);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_soap_rot_brain);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_soap_tone_detection);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_cstr_equality);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_cstr_length);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_cstr_prefix_suffix);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_cstr_contains);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_cstr_count);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_pointer_nullability);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_likely_unlikely_conditions);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_pointer_equality);
    FOSSIL_TEST_ADD(cpp_hello_pizza_test_suite, cpp_hello_pizza_test_size_comparisons);
